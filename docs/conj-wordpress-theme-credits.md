...
* [Post categories dropdown control](https://shellcreeper.com/how-to-create-sortable-checkboxes-option-in-customizer)
...
* [Text Highlighting](https://github.com/knownasilya/jquery-highlight)
